...
--
-- Name: FUNCTION update_user_role(target_user_id uuid, new_role text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.update_user_role(target_user_id uuid, new_role text) IS 'Atualiza o cargo de um usuário (apenas admins) - versão completa';


--
-- Name: update_user_role_simple(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION update_user_role_simple(target_user_id uuid, new_role text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.update_user_role_simple(target_user_id uuid, new_role text) IS 'Atualiza o cargo de um usuário (apenas admins) - versão simplificada';
...
--
-- Name: suportes_resistencias; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.suportes_resistencias (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    ativo_codigo text NOT NULL,
    ativo_nome text NOT NULL,
    suporte1 numeric(10,2),
    suporte2 numeric(10,2),
    resistencia1 numeric(10,2),
    resistencia2 numeric(10,2),
    admin_id uuid,
...
--
-- Name: suportes_resistencias suportes_resistencias_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_ativo_codigo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ativo_codigo ON public.carteira USING btree (ativo_codigo);


--
-- Name: idx_carteira_ativo_codigo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_carteira_ativo_codigo ON public.carteira USING btree (ativo_codigo);


--
-- Name: idx_carteira_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_carteira_user_id ON public.carteira USING btree (user_id);


--
-- Name: idx_suportes_ativo_codigo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_suportes_ativo_codigo ON public.suportes_resistencias USING btree (ativo_codigo);
...
CREATE INDEX idx_user_id ON public.carteira USING btree (user_id);
...
CREATE TRIGGER set_updated_at_carteira BEFORE UPDATE ON public.carteira FOR EACH ROW EXECUTE FUNCTION public.update_timestamp();


--
-- Name: suportes_resistencias set_updated_at_suportes; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: carteira carteira_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.carteira
    ADD CONSTRAINT carteira_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: suportes_resistencias suportes_resistencias_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: carteira Users can delete own carteira; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete own carteira" ON public.carteira FOR DELETE USING ((auth.uid() = user_id));


--
-- Name: carteira Users can insert own carteira; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own carteira" ON public.carteira FOR INSERT WITH CHECK ((auth.uid() = user_id));


--
-- Name: carteira Users can update own carteira; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own carteira" ON public.carteira FOR UPDATE USING ((auth.uid() = user_id));


--
-- Name: carteira Users can view own carteira; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own carteira" ON public.carteira FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: suportes_resistencias admin_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_delete ON public.suportes_resistencias FOR DELETE USING (public.is_admin());


--
-- Name: suportes_resistencias admin_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_insert ON public.suportes_resistencias FOR INSERT WITH CHECK (public.is_admin());


--
-- Name: suportes_resistencias admin_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_select ON public.suportes_resistencias FOR SELECT USING (public.is_admin());


--
-- Name: suportes_resistencias admin_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_update ON public.suportes_resistencias FOR UPDATE USING (public.is_admin());
...
--
-- Name: carteira delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY delete_own ON public.carteira FOR DELETE USING ((auth.uid() = user_id));


--
-- Name: carteira insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY insert_own ON public.carteira FOR INSERT WITH CHECK ((auth.uid() = user_id));


--
-- Name: suportes_resistencias; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.suportes_resistencias ENABLE ROW LEVEL SECURITY;

--
-- Name: carteira update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY update_own ON public.carteira FOR UPDATE USING ((auth.uid() = user_id));


--
-- Name: carteira view_own; Type: POLICY; Schema: public; Owner: -
--
